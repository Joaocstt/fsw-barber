...
const ServiceItem = ({ service, barbershop }: ServiceItempProps) => {
          ...
          <div className="flex items-center justify-between">
            ...
            <Sheet open={bookingSheetIsOpen} onOpenChange={handleBookingSheetOpenChange}>
              ...
              <SheetContent className="px-0">
                <SheetHeader>
                  <SheetTitle>Fazer Reserver</SheetTitle>
                </SheetHeader>
                  ...
                  <div className="p-5">
                    <Card>
                      <CardContent className="space-y-3 p-3">
                        ...
                        <div className="flex items-center justify-between">
                          <h2 className="text-sm font-gray-400">Data</h2>
                          <p className="text-sm">
                        ...
                        <div className="flex items-center justify-between">
                          <h2 className="text-sm font-gray-400">Hotário</h2>
                          <p className="text-sm">{selectedTime}</p>
                        </div>

                        <div className="flex items-center justify-between">
                          <h2 className="text-sm font-gray-400">Barbearia</h2>
